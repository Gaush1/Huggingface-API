<div class="p-6 lg:p-8 bg-white border-b border-gray-200">
    ...
    <h1 class="mt-8 text-2xl font-medium text-gray-900">
        Welcome to Huggingface API Testing
    </h1>
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        <div class="flex items-center">
            ...
            <h2 class="ml-3 text-xl font-semibold text-gray-900">
                <a href="http://127.0.0.1:8000/dashboard/epicdifusion">Epic-Diffusion</a>
            </h2>
        </div>
        ...
        <p class="mt-4 text-sm">
            <a href="http://127.0.0.1:8000/dashboard/epicdifusion" class="inline-flex items-center font-semibold text-indigo-700">
    ...
    <div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-6 h-6 stroke-gray-400">
            ...
            <h2 class="ml-3 text-xl font-semibold text-gray-900">
                <a href="http://127.0.0.1:8000/dashboard/analogdifusion">Analog-Diffusion</a>
            </h2>
        </div>

        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
        Analog Diffusion is a general purpose model based on Stable Diffusion 1 intended to replace the official SD releases as your default model. It is focused on providing high quality output in a wide range of different styles, with support for NFSW content.
        </p>

        <p class="mt-4 text-sm">
            <a href="http://127.0.0.1:8000/dashboard/analogdifusion" class="inline-flex items-center font-semibold text-indigo-700">
            Hosted inference API
